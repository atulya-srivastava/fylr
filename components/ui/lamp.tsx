...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        // CHANGED: bg-background -> bg-transparent
        // This ensures the main container doesn't paint a solid box over your hero section
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        >
          {/* MASKING: These must match the page background color to create the 'cut' effect */}
